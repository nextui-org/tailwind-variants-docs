...
<div className="flex gap-3">
  <button className="font-semibold text-white py-1 px-3 rounded-full active:opacity-80 bg-zinc-800 hover:bg-zinc-800">
    Button
  </button>

  <button className="font-semibold text-white py-1 px-3 active:opacity-80 text-sm rounded-lg shadow-lg uppercase tracking-wider bg-blue-500 hover:bg-blue-600 shadow-blue-500/50">
    Buy button
  </button>
</div>
...
const baseButton = tv({
  base: "font-semibold text-white py-1 px-3 rounded-full active:opacity-80 bg-zinc-800 hover:bg-zinc-800",
});

const buyButton = tv({
  extend: baseButton,
  base: "text-sm rounded-lg shadow-lg uppercase tracking-wider bg-blue-500 hover:bg-blue-600 shadow-blue-500/50",
});
...
/**
 * Result: 
 * font-semibold text-white py-1 px-3 active:opacity-80 hover:bg-zinc-800 text-sm rounded-lg
 * shadow-lg uppercase tracking-wider bg-blue-500 hover:bg-blue-600 shadow-blue-500/50
 */
