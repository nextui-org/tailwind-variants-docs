...
It's avoid to have duplicate tailwind classes. (Recommended) see more [here](https://github.com/dcastil/tailwind-merge/blob/v1.8.1/README.md)
...
**description:** The config object for `tailwind-merge` library. see more [here](https://github.com/dcastil/tailwind-merge/blob/v1.8.1/docs/configuration.md)
