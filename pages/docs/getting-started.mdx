...
If you want to use responsive variants, you need to add the **Tailwind Variants** `transformer` to your TailwindCSS config file `tailwind.config.js`.

```js copy /transformer/
// tailwind.config.js

const { transformer } = require('tailwind-variants/transformer')
...
<Callout type="warning">
  <div className="text-sm">
    **Responsive variants** can increase your CSS bundle size, so use them wisely.
  </div>
</Callout>
